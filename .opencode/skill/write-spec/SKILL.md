...
4. **tasks.md.** Разложить plan на упорядоченный TDD-чеклист (`_templates/tasks.md`):
   ...
   плане есть ≥2 дизъюнктных по файлам куска (напр. новый модуль + правки
   другого модуля + web, каждый на фейках/моках, не ждущий соседа) — выделить
   треки по волнам (шаблон, раздел «Треки и параллельность»; правило — в
   ADR 0009).
