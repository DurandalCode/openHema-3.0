...
- [x] T14. Обновлены `docs/design-sync.md` (строка «Арены»: аннотация
      «редизайн — спека 0027» и перечень новых/удалённых файлов; графа
      «новый API нужен?» осталась «нет» — единственный инкремент из
      экранной серии 0024–0027, не тронувший `docs/design-sync.md` по
      содержанию контракта), статусы `spec.md`/`plan.md`/`tasks.md` (`done`)
      и строка 0027 в `docs/specs/README.md`.
