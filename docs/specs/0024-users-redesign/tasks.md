...
- [ ] T13. **Сборка на роуте** — `app/(admin)/admin/page.tsx`: server
      ...
      заглушек трека B.
- [ ] T14. **Шапка раздела (red→green)** — тест на `UsersScreen`: крошка
...
- [ ] T15. **Удалить страницу создания** — снести
...
- [ ] T16. **Защита счётчика от лимита** — при количестве, равном лимиту
      выборки, `meta` показывает «N+ учётных записей» (план, «Риски»); тест
      на граничное значение.
- [ ] T17. **`web/AGENTS.md`** — зафиксировать правило FR-19: общая шапка
...
- [ ] T18. **`docs/design-sync.md`** — обновить строку «Пользователи»
...
- [ ] T19. `make test-web` зелёный.
- [ ] T20. `pnpm exec tsc --noEmit` без ошибок.
- [ ] T21. `pnpm build` проходит.
