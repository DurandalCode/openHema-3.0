...
Трек: 0052-arena. Волна 1. Общая согласованная база пакета.
Обязательные решения: D-API.
Прочитай и выполни:
- docs/specs/0052-shared-bout-announcement/spec.md
- docs/specs/0052-shared-bout-announcement/plan.md
- docs/specs/0052-shared-bout-announcement/tasks.md

Границы: Единственный владелец аренного API, timer, console/scoreboard и command foundation. Выполни выбранный v2 cutover и проверки старых клиентов из плана; не оставляй обход guards. Не добавляй техисходы/сходы. Поведение удержания уже решено пользователем, не спрашивай его снова.
...
Веди свой tasks.md и отчёт docs/implementation/2026-09-feedback/reports/0052-arena.md
(замени 0052-arena на имя этой задачи). Общие audit/index/decisions/waves не меняй.
