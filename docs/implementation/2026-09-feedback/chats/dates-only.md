...
Трек: dates-only, независимый запуск по launch-now.md.
Разрешённый scope: SF-04 / S-DATES из small-fixes.md.
Прочитай docs/implementation/2026-09-feedback/launch-now.md и small-fixes.md.
Только немедленная ошибка диапазона дат и её исчезновение при исправлении/очистке/отмене правок. Сохраняй серверную проверку. SF-05 автозаполнение программы и тарифы0060 не входят.
...
Общие tasks/индексы не меняй; веди только отчёт docs/implementation/2026-09-feedback/reports/dates-only.md
(замени dates-only на имя этой задачи). Общие audit/index/decisions/waves не меняй.
