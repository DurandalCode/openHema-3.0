...
Трек: 0055-bulk. Волна 1. Общая согласованная база пакета.
Обязательные решения: D-BULK.
Прочитай и выполни:
- docs/specs/0055-bulk-fighter-participation/spec.md
- docs/specs/0055-bulk-fighter-participation/plan.md
- docs/specs/0055-bulk-fighter-participation/tasks.md

Границы: Ты владелец fighter bulk API и таблицы ростера. Существующий AddToNomination восстанавливает removed: не использовать его циклом без изменения семантики по плану. Не меняй импорт CSV или merge/substitution сверх необходимого контракта.
...
Веди свой tasks.md и отчёт docs/implementation/2026-09-feedback/reports/0055-bulk.md
(замени 0055-bulk на имя этой задачи). Общие audit/index/decisions/waves не меняй.
