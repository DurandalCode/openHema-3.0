...
ALTER TABLE stage.pools ADD COLUMN arena_id UUID NULL;
...
ALTER TABLE stage.pool_layouts
...
DROP INDEX IF EXISTS stage.uq_pools_arena;
ALTER TABLE stage.pools DROP COLUMN IF EXISTS arena_id;
-- +goose StatementEnd
