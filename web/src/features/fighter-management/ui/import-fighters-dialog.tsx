    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-4xl">
        <DialogHeader>
          ...
          <DialogDescription>
            {step === "select"
              ? "Файл CSV или XLSX с колонками «имя», «клуб», «номинации». Если есть колонка «фамилия», она добавится перед именем. Регистр заголовков не важен. Сначала разбор с предпросмотром — в ростер ничего не пишется."
              : step === "preview"
