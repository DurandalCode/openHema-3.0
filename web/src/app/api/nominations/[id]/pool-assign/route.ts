...
/**
 * POST /api/nominations/[id]/pool-assign — DnD: положить бойца в пул (из
...
export async function POST(req: NextRequest, ctx: RouteContext): Promise<NextResponse> {
  ...
  try {
    const res = await poolAdminClient.assignFighter(
      { nominationId: id, fighterId: body.fighterId, poolId: body.poolId },
