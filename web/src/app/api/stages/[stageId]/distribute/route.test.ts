...
function req() {
  return new NextRequest("http://localhost/api/stages/s1/distribute", { method: "POST" });
}

describe("app/api/stages/[stageId]/distribute route", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("distributes fighters and returns layout JSON on ok", async () => {
